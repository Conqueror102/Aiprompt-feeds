...
export default function TestOGPage() {
  ...
  const ogImageUrl = `${baseUrl}/api/og?title=${encodeURIComponent('Test OG Image')}&description=${encodeURIComponent('Testing Open Graph image generation')}&category=${encodeURIComponent('Test')}&author=${encodeURIComponent('AI Prompt Hub')}`
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <h3 className="text-lg font-medium mb-2">Generated OG Image URL:</h3>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
          <h2 className="text-2xl font-semibold mb-4">OG Image Preview</h2>
